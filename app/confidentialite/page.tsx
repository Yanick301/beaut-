      ...
      <div className="container-custom max-w-4xl">
        ...
        <div className="bg-white-cream rounded-2xl p-8 md:p-12 shadow-md space-y-8 text-brown-soft leading-relaxed">
          <section>
            ...
            <p>
              Essence Féminine B.V., située à Amsterdam, Pays-Bas, est responsable du traitement de vos données personnelles. 
          ...
          <section>
            ...
            <p className="mt-4">
              Pour exercer ces droits, contactez-nous à : contact@essencefeminine.nl ou par courrier à notre adresse.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              contactez-nous à : contact@essencefeminine.nl
            </p>
          </section>
